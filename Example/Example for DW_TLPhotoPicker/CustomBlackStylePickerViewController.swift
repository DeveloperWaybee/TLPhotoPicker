...
class CustomBlackStylePickerViewController: DW_TLPhotosPickerViewController {
    override func makeUI() {
        ...
        self.popArrowImageView.image = DW_TLBundle.podBundleImage(named: "pop_arrow")?.colorMask(color: .black)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = super.tableView(tableView, cellForRowAt: indexPath) as! DW_TLCollectionTableViewCell
